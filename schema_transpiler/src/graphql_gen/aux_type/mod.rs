    ...
    kind: TypeKind::Object(ObjectType {
      ...
      fields: vec![
        FieldDefinition {
          ...
          arguments: vec![],
          ty: open_crud_name::types::QueryType::PageInfo.common_ty(TypeMod::NonOptional),
          directives: vec![],
        },
        FieldDefinition {
          description: None,
        ...
        FieldDefinition {
          ...
          arguments: vec![],
          ty: open_crud_name::types::QueryType::Aggregate.common_ty(TypeMod::NonOptional),
          directives: vec![],
        },
      ],
    }),
  ...
  Ok(TypeDefinition {
    ...
    kind: TypeKind::Object(ObjectType {
      ...
      fields: vec![
        ...
        FieldDefinition {
          description: Some("When paginating backwards, cursor to continue.".to_string()),
        ...
        FieldDefinition {
          description: Some("When paginating forwards, cursor to continue.".to_string()),
